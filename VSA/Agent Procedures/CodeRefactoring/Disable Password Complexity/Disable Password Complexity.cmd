::=================================================================================
::Script Name:        Management: Disable Password Complexity
::Description:        Disables password complexity requirement for users.
...
SET values[PasswordComplexity]=0
...
eventcreate /L Application /T INFORMATION /SO "VSA X" /ID 200 /D "Password Complexity Disabled." > nul
