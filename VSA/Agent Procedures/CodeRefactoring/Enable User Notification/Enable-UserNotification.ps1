<#
=================================================================================
Script Name:        Management: Enable User Notification.
Description:        Enables User Notification Center on Windows 10 1709 & newer.
...
[System.Diagnostics.EventLog]::WriteEntry("VSA X", "User Notification Center Enabled", "Information", 200)