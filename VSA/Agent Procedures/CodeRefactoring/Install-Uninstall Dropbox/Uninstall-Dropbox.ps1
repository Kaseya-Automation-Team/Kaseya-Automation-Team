...
If (Test-IsInstalled -ne $null) {
    ...
    $UninstallString = Test-IsInstalled|Select-Object -ExpandProperty UninstallPath
    
    Start-Process -FilePath "$UninstallString" -ArgumentList "/InstallType:MACHINE /S" -Wait
