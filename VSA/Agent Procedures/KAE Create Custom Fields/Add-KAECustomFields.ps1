...
.DESCRIPTION
    ...
    Creates a set of custom fields used by KAE Hits Pack.
...
[string[]] $FieldNames = @('KAE-SystemUptime' ,'KAE-DownloadSpeed' ,'KAE-UploadSpeed' ,'KAE-Latency' ,'KAE-SMB1' ,'KAE-BitLocker' ,'KAE-USB' ,'KAE-UEFI' ,'KAE-FireWall' ,'KAE-Guest')
