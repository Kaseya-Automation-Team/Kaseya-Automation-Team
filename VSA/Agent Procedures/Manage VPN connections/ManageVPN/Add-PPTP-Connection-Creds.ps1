...
if (1 -eq $LogIt)
{
    ...
    $LogFile = "$ScriptDir\Add-PPTPConnection-Creds.log"
...
try {
    Add-VpnConnection -Name $Name -ServerAddress $Server -TunnelType PPTP -EncryptionLevel $EncryptionLevel -AllUserConnection -ErrorAction Stop
