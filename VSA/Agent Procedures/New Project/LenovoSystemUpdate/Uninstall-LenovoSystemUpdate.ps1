## This script silently uninstalls Lenovo System Update from the computer
...
If (Test-IsInstalled -ne $null) {
    ...
    Stop-Process -Name "DJCUHost" -ErrorAction SilentlyContinue
    Start-Process -FilePath "$UninstallString" -ArgumentList "/VERYSILENT /NORESTART" -Wait
