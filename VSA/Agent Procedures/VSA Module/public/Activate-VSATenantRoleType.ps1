function Activate-VSATenantRoleType {
    <#
    .Synopsis
    ...
    .EXAMPLE
       Activate-VSATenantRoleType -TenantName 'YourTenant' -RoleTypes 'SB Admin', 'KDP Admin'
    .EXAMPLE
       Activate-VSATenantRoleType -TenantId 1001 -ModuleIds 105, 106
    .INPUTS
...
Export-ModuleMember -Function Activate-VSATenantRoleType