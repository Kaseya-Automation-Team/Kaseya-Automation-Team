function Add-VSAMachineGroup
{
    ...
    .EXAMPLE
       Add-VSAMachineGroup -Ordid "34543554343" -MachineGroupName "Kaseya"
	.EXAMPLE
       Add-VSAMachineGroup -Ordid "34543554343" -MachineGroupName "Kaseya" -ParentMachineGroupId "3243243242332"
    .EXAMPLE
