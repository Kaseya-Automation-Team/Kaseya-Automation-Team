function Add-VSASheduleAuditLatest
{
    <#
    .Synopsis
    ...
    .PARAMETER ExcludeTo
        ExclusionWindow
    .EXAMPLE
       Add-VSASheduleAuditLatest -AgentID 10001 -Repeat Never
    .EXAMPLE
       Add-VSASheduleAuditLatest -AgentID 10001 -Repeat Never -VSAConnection $connection
    .INPUTS
...
Export-ModuleMember -Function Add-VSASheduleAuditLatest