function Add-VSASheduleAuditSysInfo
{
    <#
    .Synopsis
    ...
    .PARAMETER ExcludeTo
        ExclusionWindow
    .EXAMPLE
       Add-VSASheduleAuditSysInfo -AgentID 10001 -Repeat Never
    .EXAMPLE
       Add-VSASheduleAuditSysInfo -AgentID 10001 -Repeat Never -VSAConnection $connection
    .INPUTS
...
Export-ModuleMember -Function Add-VSASheduleAuditSysInfo