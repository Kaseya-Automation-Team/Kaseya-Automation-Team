function Add-VSAStaffToDepartment
{
    <#
    .Synopsis
    ...
    .EXAMPLE
       Add-VSAStaffToDepartment -DepartmentId 10001 -OrgIdNumber 20002 -StaffFullName 'John Doe'
    .INPUTS
...
Export-ModuleMember -Function Add-VSAStaffToDepartment