function Deactivate-VSATenant
{
    ...
    .EXAMPLE
       Deactivate-VSATenant -TenantName 'TenantToDeactivate'
    .EXAMPLE
       Deactivate-VSATenant -TenantId 10001 -VSAConnection $connection
    .INPUTS
...
Export-ModuleMember -Function Deactivate-VSATenant