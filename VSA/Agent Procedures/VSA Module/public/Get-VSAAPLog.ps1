function Get-VSAAPLog
{
    <#
    .Synopsis
       Returns VSA agent procedures' log.
    .DESCRIPTION
       Returns the VSA agent procedures' for given Agent Id.
    ...
    .EXAMPLE
       Get-VSAAPLog -AgentId '00001'
    .EXAMPLE
       Get-VSAAPLog -VSAConnection $connection -AgentId '00001'
    .INPUTS
    ...
    param ( 
        ...
        [string] $URISuffix = "api/v1.0/assetmgmt/logs/{0}/agentprocedure",
        [Parameter(Mandatory = $true)]
        [ValidateScript({
            if( $_ -notmatch "^\d+$" ) {
