function Get-VSASDCategories {
    ...
    .EXAMPLE
       Get-VSASDCategories -ServiceDeskId 3434343
    .EXAMPLE
       Get-VSASDCategories -VSAConnection $connection -ServiceDeskId 3434343
    .INPUTS
...
Export-ModuleMember -Function Get-VSASDCategories