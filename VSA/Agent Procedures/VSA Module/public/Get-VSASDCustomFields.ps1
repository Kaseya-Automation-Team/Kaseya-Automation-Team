function Get-VSASDCustomFields {
    <#
    .Synopsis
    ...
    .EXAMPLE
       Get-VSASDCustomFields -ServiceDeskId 3434343
    .EXAMPLE
       Get-VSASDCustomFields -VSAConnection $connection -ServiceDeskId 3434343
    .INPUTS
    ...
    param ( 
        ...
        [string] $URISuffix = 'api/v1.0/automation/servicedesks/{0}/customfields',
        [ValidateNotNullOrEmpty()]
...
Export-ModuleMember -Function Get-VSASDCustomFields