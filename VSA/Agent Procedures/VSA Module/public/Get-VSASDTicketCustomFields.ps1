function Get-VSASDTicketCustomFields {
    <#
    .Synopsis
    ...
    .EXAMPLE
       Get-VSASDTicketCustomFields -ServiceDeskTicketId 3434343 -CustomFieldId 32323232
    .EXAMPLE
       Get-VSASDTicketCustomFields -VSAConnection $connection -ServiceDeskTicketId 3434343 -CustomFieldId 32323232
    .INPUTS
...
Export-ModuleMember -Function Get-VSASDTicketCustomFields