function Add-VSAScheduleAuditBaseLine
{
    <#
    .Synopsis
    ...
    .PARAMETER ExcludeTo
        ExclusionWindow
    .EXAMPLE
       Add-VSAScheduleAuditBaseLine -AgentID 10001 -Repeat Never
    .EXAMPLE
       Add-VSAScheduleAuditBaseLine -AgentID 10001 -Repeat Never -VSAConnection $connection
    .INPUTS
...
Export-ModuleMember -Function Add-VSAScheduleAuditBaseLine