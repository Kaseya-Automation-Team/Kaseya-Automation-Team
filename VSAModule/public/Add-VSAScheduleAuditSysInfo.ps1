function Add-VSAScheduleAuditSysInfo
{
    <#
    .Synopsis
    ...
    .PARAMETER ExcludeTo
        ExclusionWindow
    .EXAMPLE
       Add-VSAScheduleAuditSysInfo -AgentID 10001 -Repeat Never
    .EXAMPLE
       Add-VSAScheduleAuditSysInfo -AgentID 10001 -Repeat Never -VSAConnection $connection
    .INPUTS
...
Export-ModuleMember -Function Add-VSAScheduleAuditSysInfo