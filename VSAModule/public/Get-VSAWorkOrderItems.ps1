function Get-VSAWorkOrderItems {
    <#
    .Synopsis
    ...
    .EXAMPLE
       Get-VSAWorkOrderItems -CustomerId 23232432423 -WorkOrderId 342356456456
    .EXAMPLE
       Get-VSAWorkOrderItems -VSAConnection $connection -CustomerId 23232432423 -WorkOrderId 342356456456
    .INPUTS
...
Export-ModuleMember -Function Get-VSAWorkOrderItems