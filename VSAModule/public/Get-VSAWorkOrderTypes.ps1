function Get-VSAWorkOrderTypes {
    <#
    .Synopsis
    ...
    .EXAMPLE
       Get-VSAWorkOrderTypes -VSAConnection $connection
    .INPUTS
    ...
    param ( 
        ...
        [string] $URISuffix = 'api/v1.0/system/customers/resourcetypes',
...
Export-ModuleMember -Function Get-VSAWorkOrderTypes