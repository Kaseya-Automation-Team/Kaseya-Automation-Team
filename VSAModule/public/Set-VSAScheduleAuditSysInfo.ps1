function Set-VSAScheduleAuditSysInfo
{
    <#
    .Synopsis
       Schedules a sysinfo audit.
    .DESCRIPTION
    ...
    .PARAMETER ExcludeTo
        ExclusionWindow
    .EXAMPLE
       Set-VSAScheduleAuditSysInfo -AgentID 10001 -Repeat Never
    .EXAMPLE
       Set-VSAScheduleAuditSysInfo -AgentID 10001 -Repeat Never -VSAConnection $connection
    .INPUTS
    ...
    param ( 
        ...
        [string] $URISuffix = 'api/v1.0/assetmgmt/audit/sysinfo/{0}/schedule', 
    ...
    DynamicParam {
        if ( $Repeat -ne 'Never' ) {
            ...
            $RuntimeParameterDictionary.Add('EndAfterIntervalTimes', (New-VSARuntimeParameter -Name 'EndAfterIntervalTimes' -Type ([int])))
            ...
            $RuntimeParameterDictionary.Add('EndAt', (New-VSARuntimeParameter -Name 'EndAt' -Type ([string])))
            $RuntimeParameterDictionary.Add('EndOn', (New-VSARuntimeParameter -Name 'EndOn' -Type ([string])))
...
Export-ModuleMember -Function Set-VSAScheduleAuditSysInfo -Alias Add-VSAScheduleAuditSysInfo