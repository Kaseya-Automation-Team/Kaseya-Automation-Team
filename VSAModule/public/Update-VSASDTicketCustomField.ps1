function Update-VSASDTicketCustomField
{
    <#
    .Synopsis
    ...
    .EXAMPLE
       Update-VSASDTicketCustomField -ServiceDeskTicketId 3256598065654 -CustomFieldId 376887433552 -Value "Automatic"
    .EXAMPLE
...
New-Alias -Name Update-VSASDCustomField -Value Update-VSASDTicketCustomField -Force
Export-ModuleMember -Function Update-VSASDTicketCustomField -Alias Update-VSASDCustomField